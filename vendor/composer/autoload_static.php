...
class ComposerStaticInit22c5151fefa8774cd8a4c36170f461a5
{
    ...
    public static $classMap = array (
        'AuditController' => __DIR__ . '/../..' . '/controllers/AuditController.php',
        'AuditLog' => __DIR__ . '/../..' . '/models/AuditLog.php',
        ...
        'Batch' => __DIR__ . '/../..' . '/models/Batch.php',
        'BatchController' => __DIR__ . '/../..' . '/controllers/BatchController.php',
        'ClassController' => __DIR__ . '/../..' . '/controllers/ClassController.php',
        'ClassModel' => __DIR__ . '/../..' . '/models/ClassModel.php',
        'Composer\\InstalledVersions' => __DIR__ . '/..' . '/composer/InstalledVersions.php',
        'DashboardController' => __DIR__ . '/../..' . '/controllers/DashboardController.php',
        'Database' => __DIR__ . '/../..' . '/config/Database.php',
        'Dompdf\\Cpdf' => __DIR__ . '/..' . '/dompdf/dompdf/lib/Cpdf.php',
        'Familia' => __DIR__ . '/../..' . '/models/Familia.php',
        'FamiliasController' => __DIR__ . '/../..' . '/controllers/FamiliasController.php',
        'Financeiro' => __DIR__ . '/../..' . '/models/Financeiro.php',
        'FinanceiroController' => __DIR__ . '/../..' . '/controllers/FinanceiroController.php',
        'Product' => __DIR__ . '/../..' . '/models/Product.php',
        'ProductController' => __DIR__ . '/../..' . '/controllers/ProductController.php',
        'Produto' => __DIR__ . '/../..' . '/models/Produto.php',
        'ProdutosController' => __DIR__ . '/../..' . '/controllers/ProdutosController.php',
        'RelatoriosController' => __DIR__ . '/../..' . '/controllers/RelatoriosController.php',
        'ReportController' => __DIR__ . '/../..' . '/controllers/ReportController.php',
        'Rifa' => __DIR__ . '/../..' . '/models/Rifa.php',
        'RifasController' => __DIR__ . '/../..' . '/controllers/RifasController.php',
        ...
        'Turma' => __DIR__ . '/../..' . '/models/Turma.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit22c5151fefa8774cd8a4c36170f461a5::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit22c5151fefa8774cd8a4c36170f461a5::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit22c5151fefa8774cd8a4c36170f461a5::$classMap;
